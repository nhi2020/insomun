...
<div class="container">
	...
	<table class="table mx-auto">
		...
		<form>
			...
			<form action="/shop/user/deal/dealUserSellerList.do">
				<div class="input-group mb-3">
					<input type="text" class="form-control" placeholder="구매자"
						aria-label="Username" aria-describedby="basic-addon1" name="searchWrd">
					<div class="input-group-append">
						<input class="btn btn-secondary" type="submit" value="검색" />
					</div>
					<div class="input-group-append">
						<button type="button" class="btn btn-secondary" onclick="location.href='/shop/user/deal/dealUserSellerList.do'"><i class="fa fa-bars">목록으로</i></button>
					</div>
				</div>
