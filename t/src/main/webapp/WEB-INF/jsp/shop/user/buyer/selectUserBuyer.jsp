...
<body>
	...
	<div class="row px-md-5">
		<div class="mx-auto">
			...
			<p class="m-3">${BuyerVO.nickname }님은${BuyerVO.snscode } 계정으로 로그인
				중이십니다.</p>
		</div>
	</div>
	<div class="row m-3">
		...
		<div class="col-lg-6 col-md-8 col-sm-10 my-1 myList">
			...
			<ol>
				<c:forEach var="basket" items="${myBasket }">
					<li class="m-2"><b>${basket.p_name }, </b> ${basket.ba_q }개, <fmt:formatNumber
							value="${basket.ba_q * basket.p_price }" pattern="#,###" />원</li>
				</c:forEach>
			</ol>
			...
			<button class="float-right m-3 btn btn-outline-danger"
				onclick="location.href='/shop/user/basket/listBasketUser.do'">더
				보기...</button>
		</div>
		<div class="col-lg-3 col-md-2 col-sm-1"></div>
	</div>
		...
		<div class="col-lg-6 col-md-8 col-sm-10 myList">
			...
			<ol>
				<c:forEach var="deal" items="${myDeal }">
					<li class="m-2"><b>${deal.p_name }, </b> ${deal.d_ing },
						${deal.d_regdate }</li>
				</c:forEach>
			</ol>
			...
			<button class="float-right m-3 btn btn-outline-danger"
				onclick="location.href='/shop/user/deal/dealUserBuyerList.do'">더
				보기...</button>
		</div>
		<div class="col-lg-3 col-md-2 col-sm-1"></div>
	</div>
		...
		<div class="col-lg-6 col-md-8 col-sm-10 myList">
			...
			<ol>
				<c:forEach var="like" items="${myLike }">
					<li class="m-2"><b>${like.p_name }, </b> ${like.l_regdate }</li>
				</c:forEach>
			</ol>
			...
			<button class="float-right m-3 btn btn-outline-danger"
				onclick="location.href='/shop/user/like/LikeUserList.do'">더
				보기...</button>
		</div>
		<div class="col-lg-3 col-md-2 col-sm-1"></div>
	</div>
