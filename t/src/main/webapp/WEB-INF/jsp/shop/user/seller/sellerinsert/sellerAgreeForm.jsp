...
<%@ include file="../../../inc/EgovShopHeader.jsp" %>
 ...
 <div class="wrap1" style="padding: 50px 40%">
      ...
      <textarea rows="5" cols="30">제 1 장 총칙
...
본 약관은 2020년 10월 19일부터 적용한다.
      ...
      <div style="border: 1px solid"><p>본인은 귀사에 이력서를 제출함에 따라 [개인정보 보호법] 제15조 및 제17조에 따라
아래의 내용으로 개인정보를 수집, 이용 및 제공하는데 동의합니다. □ 개인정보의 수집 및 이용에 관한 사항
...
류로 활용하며, 목적 외의 용도로는 사용하지 않습니다. □ 개인정보의 보관 및 이용 기간
- 귀하의 개인정보를 다음과 같이 보관하며, 수집, 이용 및 제공목적이 달성된 경우
[개인정보 보호법] 제21조에 따라 처리합니다.</p></div>
