...
<img src="<c:url value='/images/shop/main/main.jpg'/>" width=800 height="450"> 
<div style="left: 350px; width: 450px; bottom: 140px; font-size: 1.8em; font-weight: bold; position: absolute;">
	<h1>입소문넷</h1>
	믿음직한 농산품 직거래
	입소문넷 입니다.
	    ...
	    <div class="row">
			...
			<div class="col-3">
				...
				<p>
					...
					<span>판매자 아이디: ${product_list.s_id }</span>
