...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="generalTable">
      ...
      <c:if test="${bdMstr.bbsId == 'BBSMSTR_TTTTTTTTTTTT'}"> 
      <tr> 
        <td class="td_width"><spring:message code="cop.nttPrice" />
        <img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/></td>
        <td class="td_content">
          <input name="nttPrice" title="<spring:message code="cop.nttPrice" />" type="text" size="60" value='<c:out value="${result.nttPrice}" />'  maxlength="60" >
           <br/><form:errors path="nttPrice" /> 
        </td>
      </tr>  
      </c:if>
