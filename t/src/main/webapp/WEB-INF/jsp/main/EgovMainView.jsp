		...
		<div id="leftcontent_wrap">
			...
			<div class="leftcontent01">
				...
				<div class="leftcontent01_btn">
					<ul>
						<li><a href="/shop/product/EgovMngMain.do"><img src="<c:url value='/'/>images/header/btn_leftcontent01.gif" width="70" height="87" alt="입소문 마켓" title="자세히 보기 링크를 통해 입소문 마켓화면으로 이동합니다." /></a></li>
					</ul>
				</div>
			</div>
			<!-- //한번에 신청하는 민원 끝 -->
