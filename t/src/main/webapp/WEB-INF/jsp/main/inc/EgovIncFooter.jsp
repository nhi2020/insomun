...
<div id="footer_copyright">
	<div class="mp_loc"><img src="<c:url value='/'/>images/footer/img1.png" alt="행정안전부" /></div>
	<div class="nia_loc"><img src="<c:url value='/'/>images/footer/img2.png" alt="한국정보화진흥원" /></div>
