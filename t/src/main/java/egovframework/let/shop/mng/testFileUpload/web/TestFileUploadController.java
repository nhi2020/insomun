...
public class TestFileUploadController {
	...
	public String insertTestFileUpload(@ModelAttribute("searchVO")TestFileUploadVO vo, HttpServletRequest request, Model model) {
	...
	public String insertTestFileUploadPro(HttpServletRequest request, MultipartFile file, TestFileUploadVO vo, String path, Model model)
			throws Exception {
		// 업로드용 경로 설정
