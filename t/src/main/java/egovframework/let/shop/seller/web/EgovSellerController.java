...
public class EgovSellerController {

	@Resource(name = "EgovSellerService")
	private EgovSellerService sellerService;
	...
	@RequestMapping(value = "/shop/seller/EgovSellerpro.do")
	public String String (SellerVO vo, HttpServletRequest request, ModelMap model) throws Exception{
		List<SellerVO> list = sellerService.selectSellerList(vo);
		model.addAttribute("list", list);
		return "shop/EgovSellerList";
	}
}
