 ...
 *  </pre>
 */
@Repository("EgovMngProDAO")
public class EgovMngProDAO extends EgovAbstractDAO {
	...
	return (List<ProVO>) list("EgovMngProDAO.selectMngProList", proVO);
    }

    public int selectMngProListCnt(ProVO proVO) throws Exception {
    	return (Integer)select("EgovMngProDAO.selectMngProListCnt", proVO);
    }
}
